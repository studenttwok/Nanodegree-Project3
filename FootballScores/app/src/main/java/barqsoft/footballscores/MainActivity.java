...
public class MainActivity extends ActionBarActivity
{
    ...
    private final String fragmentTag = "my_main";
    ...
    protected void onSaveInstanceState(Bundle outState)
    {
        ...
        getSupportFragmentManager().putFragment(outState,fragmentTag,my_main);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        my_main = (PagerFragment) getSupportFragmentManager().getFragment(savedInstanceState,fragmentTag);
